...
export const BOX_COLOR = "#222222"; //#212123
export const ORANGE_DARK_COLOR = "rgba(252, 112, 25, 0.6)";
export const RED_COLOR = "#FE4237";
export const BACKDROP_COLOR = "rgba(0,0,0,0.7)";
export const GREEN_COLOR = "#04B500";
export const YELLOW_COLOR = "#FFFF00";
export const PADDING_HORIZONTAL = "4.5%";
export const PADDING_TOP = Constants.statusBarHeight + 5;
